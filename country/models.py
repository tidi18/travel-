...
class Country(models.Model):
    ...
    alpha2_code = models.CharField(max_length=255, blank=True, verbose_name='Двухбуквенный код страны')
    alpha3_code = models.CharField(max_length=255, blank=True, verbose_name='Трехбуквенный код страны')
